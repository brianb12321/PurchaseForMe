...
exports.WebConsole = void 0;
__webpack_require__(/*! jq-console */ "./node_modules/jq-console/jqconsole.min.js");
class WebConsole {
    initialize() {
        this.console = $('#console').jqconsole("Console ready\n", ">>>", "", true);
    }
    write(message) {
...
/***/ "./src/_build/signalR/SignalRRunner.js":
/*!*********************************************!*\
  !*** ./src/_build/signalR/SignalRRunner.js ***!
  \*********************************************/
...
class SignalRRunner {
    ...
    setup() {
        this.connection = new signalR.HubConnectionBuilder()
            .withUrl(this.url)
            .build();
        this.connection.on("Result", (result) => {
            this.onResult(result);
        });
        this.connection.on("Console", result => {
    ...
    connect() {
        this.connection.start()
            .then(() => {
            this.onConnected();
            this === null || this === void 0 ? void 0 : this.onConnectedEvent();
        })
            .catch(error => this.onConnectionError(error));
    }
}
exports.SignalRRunner = SignalRRunner;
//# sourceMappingURL=SignalRRunner.js.map

/***/ }),

/***/ "./src/_build/signalR/SignalRTaskRunner.js":
/*!*************************************************!*\
  !*** ./src/_build/signalR/SignalRTaskRunner.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SignalRTaskRunner = void 0;
const SignalRRunner_1 = __webpack_require__(/*! ./SignalRRunner */ "./src/_build/signalR/SignalRRunner.js");
const signalR = __importStar(__webpack_require__(/*! @microsoft/signalr */ "./node_modules/@microsoft/signalr/dist/esm/index.js"));
class SignalRTaskRunner extends SignalRRunner_1.SignalRRunner {
    constructor(taskConsole) {
        super();
    ...
    onConnectionError(error) {
        this.taskConsole.writeLine(`An error occurred while establishing a connection to the task runner: ${error}`);
    }
}
exports.SignalRTaskRunner = SignalRTaskRunner;
//# sourceMappingURL=SignalRTaskRunner.js.map
...
/*!***************************************!*\
  !*** ./src/_build/initTaskConsole.js ***!
  \***************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const WebConsole_1 = __webpack_require__(/*! ./WebConsole */ "./src/_build/WebConsole.js");
const SignalRTaskRunner_1 = __webpack_require__(/*! ./signalR/SignalRTaskRunner */ "./src/_build/signalR/SignalRTaskRunner.js");
let taskConsole = new WebConsole_1.WebConsole();
$("#runButton").click(event => {
    ...
    var connection = new SignalRTaskRunner_1.SignalRTaskRunner(taskConsole);
...
//# sourceMappingURL=initTaskConsole.js.map
})();

/******/ })()
;
//# sourceMappingURL=taskConsole.bundle.min.js.map