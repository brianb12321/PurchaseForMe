...
class WebConsole {
    initialize() {
        this.console = new xterm_1.Terminal();
        let fitAddon = new xterm_addon_fit_1.FitAddon();
...
/***/ "./src/_build/signalR/SignalRCodeRunner.js":
/*!*************************************************!*\
  !*** ./src/_build/signalR/SignalRCodeRunner.js ***!
  \*************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SignalRCodeRunner = void 0;
...
class SignalRCodeRunner extends SignalRRunner_1.SignalRRunner {
    constructor(console) {
        super();
    ...
    registerToCodeMonitor(codeGuid) {
    ...
    onConnectionError(error) {
        this.console.writeLine(`An error occurred while establishing a connection to the code monitor: ${error}`);
    }
}
exports.SignalRCodeRunner = SignalRCodeRunner;
//# sourceMappingURL=SignalRCodeRunner.js.map
...
const SignalRCodeRunner_1 = __webpack_require__(/*! ./signalR/SignalRCodeRunner */ "./src/_build/signalR/SignalRCodeRunner.js");
...
$("#runButton").click(event => {
    ...
    var connection = new SignalRCodeRunner_1.SignalRCodeRunner(taskConsole);
